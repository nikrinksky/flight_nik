...
class FilterIntervalBetweenArrivalAndDepartureTest {

    //Этот тест создает объект FilterIntervalBetweenArrivalAndDeparture,
    // создает несколько сегментов и рейсов,
    // а затем проверяет, что метод filterFlights
    // корректно фильтрует рейсы в соответствии с условиями метода.
    @Test
