...
class DepartureFilterUpToCurrentTimeTest {
    //Этот тест создает объект DepartureFilterUpToCurrentTime,
    // создает несколько сегментов и рейсов, а затем проверяет,
    // что метод filterFlights корректно фильтрует рейсы
    // в соответствии с условиями метода.
    @Test
    public void testFilterFlights() {
        DepartureFilterUpToCurrentTime filter = new DepartureFilterUpToCurrentTime();
